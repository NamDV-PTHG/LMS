...
export default function PwaLoginPage() {
  ...
  const onSubmit = async (data: LoginForm) => {
    ...
    try {
      ...
      // auth-provider sẽ redirect đến /app/home tự động
    } catch (err: unknown) {
      const message =
      ...
      <div className="relative z-10 w-full max-w-sm mx-4">
        <div className="bg-surface rounded-xl border border-default shadow-card p-6">
          ...
          <div className="text-center mb-6">
            {branding.logoUrl ? (
              <img src={branding.logoUrl} alt="Logo" className="h-12 w-auto mx-auto mb-4 object-contain" />
            ) : (
          ...
          <form onSubmit={handleSubmit(onSubmit)} noValidate className="space-y-4">
            ...
            <div className="space-y-1.5">
              <label htmlFor="email" className="block text-[12px] font-medium text-content">Email</label>
              <input
                id="email"
                type="email"
            ...
            <div className="space-y-1.5">
              <label htmlFor="password" className="text-[12px] font-medium text-content">Mật khẩu</label>
